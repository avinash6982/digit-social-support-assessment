...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const baseClasses = 'relative inline-flex items-center justify-center gap-2.5 font-semibold py-3.5 px-9 rounded-2xl cursor-pointer overflow-hidden z-10 transition-all duration-300 ease-out active:translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500'
